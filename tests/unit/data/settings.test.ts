...
describe("SettingsUtil", () => {
    test("first-run update checking is opt-in and does not automatically request the newest version by default", () => {
        expect(DEFAULT_SETTINGS.showUpdateAvailableStatusBarItem).toBe(false);
    });
